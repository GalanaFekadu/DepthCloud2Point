...
class Settings(BaseSettings):
    # Environment
    snapshot_path: Path = r"/root/DepthCloud2Point/dataset/image"
    ...
    # Training
    train_dataset_path: Path = r"/root/DepthCloud2Point/dataset/shapenetcorev2_hdf5_2048/train_files.txt"
    val_dataset_path: Path = r"/root/DepthCloud2Point/dataset/shapenetcorev2_hdf5_2048/val_files.txt"
    epoch: list[int] = [10]
    learning_rate: list[float] = [5e-5]
    # Testing
    test_dataset_path: Path = r"/root/DepthCloud2Point/dataset/shapenetcorev2_hdf5_2048/test_files.txt"
    model_path: Path = r"/root/DepthCloud2Point/model/2022-09-15_11-32-03_param.pt"
