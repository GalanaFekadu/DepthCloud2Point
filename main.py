...
from lib.model import DepthCloud2Point
...
class MyProcess():
    ...
    def save_weight(self):
        self.writer.add_histogram('Layer1_Conv/weight', self.DepthCloud2Point.layer1[0].weight, global_step=self.global_step)
        self.writer.add_histogram('Layer1_Conv/bais', self.DepthCloud2Point.layer1[0].bias, global_step=self.global_step)
        self.writer.add_histogram('Layer2_Conv/weight', self.DepthCloud2Point.layer2[0].weight, global_step=self.global_step)
        self.writer.add_histogram('Layer2_Conv/bais', self.DepthCloud2Point.layer2[0].bias, global_step=self.global_step)
        self.writer.add_histogram('Layer3_Conv/weight', self.DepthCloud2Point.layer3[0].weight, global_step=self.global_step)
        self.writer.add_histogram('Layer3_Conv/bais', self.DepthCloud2Point.layer3[0].bias, global_step=self.global_step)
        self.writer.add_histogram('Layer4_Conv/weight', self.DepthCloud2Point.layer4[0].weight, global_step=self.global_step)
        self.writer.add_histogram('Layer4_Conv/bais', self.DepthCloud2Point.layer4[0].bias, global_step=self.global_step)
        self.writer.add_histogram('Layer5_Conv/weight', self.DepthCloud2Point.layer5[0].weight, global_step=self.global_step)
        self.writer.add_histogram('Layer5_Conv/bais', self.DepthCloud2Point.layer5[0].bias, global_step=self.global_step)
        self.writer.add_histogram('Layer6_Conv/weight', self.DepthCloud2Point.layer6[0].weight, global_step=self.global_step)
        self.writer.add_histogram('Layer6_Conv/bais', self.DepthCloud2Point.layer6[0].bias, global_step=self.global_step)
        self.writer.add_histogram('Layer7_Conv/weight', self.DepthCloud2Point.layer7[0].weight, global_step=self.global_step)
        self.writer.add_histogram('Layer7_Conv/bais', self.DepthCloud2Point.layer7[0].bias, global_step=self.global_step)
        self.writer.add_histogram('fc1/weight', self.DepthCloud2Point.fc1[0].weight, global_step=self.global_step)
        self.writer.add_histogram('fc1/bais', self.DepthCloud2Point.fc1[0].bias, global_step=self.global_step)
        self.writer.add_histogram('fc2/weight', self.DepthCloud2Point.fc2[0].weight, global_step=self.global_step)
        self.writer.add_histogram('fc2/bais', self.DepthCloud2Point.fc2[0].bias, global_step=self.global_step)
        self.writer.add_histogram('fc3/weight', self.DepthCloud2Point.fc3[0].weight, global_step=self.global_step)
        self.writer.add_histogram('fc3/bais', self.DepthCloud2Point.fc3[0].bias, global_step=self.global_step)
        self.writer.add_histogram('fc4/weight', self.DepthCloud2Point.fc4.weight, global_step=self.global_step)
        self.writer.add_histogram('fc4/bais', self.DepthCloud2Point.fc4.bias, global_step=self.global_step)
    ...
    def train_validation(self):
        for key, data in enumerate(product(*[v for v in self.parameters.values()])):
            ...
            self.pixel2point = DepthCloud2Point(initial_point=self.hparam.initial_point).to(self.device)
